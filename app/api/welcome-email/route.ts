              ...
              <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
                ...
                <tr><td style="padding:28px 32px;color:#2a2a2a;font-size:14px;line-height:1.6;">
                  ...
                  <p style="margin-top:24px;">
                    <a href="https://www.blackscottishcommunicators.org.uk/login" style="background:#a9843c;color:#0e0d0c;text-decoration:none;padding:12px 22px;border-radius:6px;font-weight:bold;display:inline-block;">Go to Member Login</a>
                  </p>
                  <p style="margin-top:28px;color:#6b6b6b;font-size:13px;">Questions? Just reply to this email or reach hello@blackscottishcommunicators.org.uk.</p>
                </td></tr>
              </table>
            </td></tr>
          </table>
